...
// Dual Logo Component: Image for mobile, Font for desktop
const SearchInLogo = ({ color = "var(--accent-gold)" }) => (
  <div className="brand-logo-container">
    ...
    <img src="/luqya with bgg.png" alt="لُقْيَا" className="brand-logo-mobile" />
  </div>
);
...
const ResultCard = ({ hit, mode }) => {
  ...
  return (
    <div className="result-card">
      ...
      <div className="ayah-text arabic-text" dir="rtl" lang="ar">
        {hit.text_uthmani}
...
function App() {
  ...
  // Auto-scroll on mobile when results are loaded
  useEffect(() => {
  ...
  const handleSearch = async (e, forcedMode = null) => {
    ...
    try {
      ...
      const response = await axios.get(`${API_BASE}/api/search`, {
        params: { q: query, mode: currentMode }
      });
  ...
  return (
    <div className="app-container">
        ...
        <form onSubmit={handleSearch} style={{ width: '100%', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
          ...
          <div className="mode-selector">
            ...
            <button 
              ...
              onMouseDown={() => { setMode('ayah_only'); handleSearch(null, 'ayah_only'); }}
            ...
            <button 
              ...
              onMouseDown={() => { setMode('tafsir_only'); handleSearch(null, 'tafsir_only'); }}
              onClick={(e) => e.preventDefault()}
            >
              <Library size={18} />
            ...
            <button 
              ...
              onMouseDown={() => { setMode('semantic_root'); handleSearch(null, 'semantic_root'); }}
              onClick={(e) => e.preventDefault()}
            >
              <Sparkles size={18} />
      ...
      {results && !loading && (
        <section className="results-area" ref={resultsRef}>
